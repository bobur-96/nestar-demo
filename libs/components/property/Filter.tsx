	...
	return (
		<Stack className='filter-main'>
			...
			<Stack className='find-your-home' mb='30px'>
				...
				>
					{['SEOUL', 'BUSAN', 'INCHEON', 'KIMHAE'].map(location => (
			...
			<Stack className='find-your-home' mb='30px'>
				...
				{['APARTMENT', 'HOUSE', 'VILLA', 'TWO-ROOM'].map(type => (
			...
			<FormControl>
				<InputLabel>neo</InputLabel>
				<Select value={0} label='Neo'>
			...
			<Stack className='find-your-home'>
				...
				<Stack className='square-year-input' direction='row' spacing={2}>
					...
					<input
						...
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
							const value = parseInt(e.target.value) || 0
							if (value >= 0) setPropertyPrice({ ...propertyPrice, end: value })
						}}
					/>
				</Stack>
			</Stack>
